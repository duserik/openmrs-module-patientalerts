 ...
 */
package org.openmrs.module.patientalerts.service;
...
/**
 * The Patient Alerts Services deal with notifying the clinicians when patients� records with data
 * indicating the need for immediate attention appear in the system.
 * 
 * @author kamonyo & dusabe
 */
@Transactional(readOnly=true)
public interface PatientAlertsService {
